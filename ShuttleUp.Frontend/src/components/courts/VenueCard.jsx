      ...
      <div className={isList ? 'featured-venues-item venue-list-item' : 'wrapper'}>
        <div className="listing-item listing-item-grid">
          <div className="listing-img">
            <Link to={`/courts/${venue.id ?? venue.venueId ?? 1}`}>
          ...
          <div className="listing-content">
            ...
            <h3 className="listing-title">
              <Link to={`/courts/${venue.id ?? venue.venueId ?? 1}`}>{venue.name}</Link>
            </h3>
            ...
            <div className="listing-button">
              ...
              <Link to={`/courts/${venue.id ?? venue.venueId ?? 1}`} className="user-book-now">
