...
export default function WorkSection() {
  const steps = [
    ...
    { icon: '/assets/img/icons/work-icon2.svg', title: 'Lựa Chọn Sân Bãi', link: '/venues', desc: 'Xem chi tiết và lựa chọn các sân cầu lông với cơ sở vật chất chất lượng cao.', btn: 'Đi Tới Danh Sách' },
