      ...
      <div className="d-flex align-items-center justify-content-between gap-3 mb-4 pb-3 border-bottom flex-wrap">
        ...
        <div className="d-flex align-items-center gap-2">
          <button
            ...
            disabled={!venueId}
            title={!venueId ? 'Cần lưu venue trước để xem preview' : undefined}
          >
            <i className="feather-eye me-2" />
            Xem giao diện người chơi
          </button>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="d-flex flex-wrap gap-2 mb-4">
          ...
          <button
            ...
            style={{ borderRadius: 999 }}
            disabled={!venueId}
            title={!venueId ? 'Lưu cụm sân trước để cấu hình chính sách' : undefined}
          >
                  ...
                  <div className="d-flex align-items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-muted" style={{ fontSize: 13 }}>
                        Bấm <strong>&quot;Xem giao diện người chơi&quot;</strong> ở góc phải trên để xem preview trước khi lưu.
                      </div>
                      {!venueId && (
                        <div className="mt-2 small text-danger">Oops… Bạn cần lưu cụm sân trước để cấu hình chính sách.</div>
                      )}
                    </div>
                  </div>
                </div>
            ...
            <div className="modal-dialog modal-dialog-centered modal-lg" onClick={(e) => e.stopPropagation()}>
              <div className="modal-content" style={{ borderRadius: 14 }}>
                ...
                <div className="modal-body">
                  <div className="mb-3">
                    <div className="fw-semibold" style={{ color: '#0f172a' }}>{form.name || 'Cụm sân'}</div>
                    <div className="text-muted small">{assembleAddress() || '—'}</div>
                  </div>

                  <div className="row g-3">
                    <div className="col-12 col-lg-7">
                      <div style={{ fontSize: 12, fontWeight: 700, color: '#7c3aed', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 }}>
                        <i className="feather-book-open me-1" style={{ fontSize: 12 }} />
                        Quy định tại sân
                      </div>
                      {policyForm.venueRules?.trim() ? (
                        <div style={{
                          background: '#faf5ff',
                        ...
                        <div style={{ background: '#f1f5f9', borderRadius: 10, padding: '20px 16px', textAlign: 'center', color: '#94a3b8', fontSize: 13 }}>
                    ...
                    <div className="col-12 col-lg-5">
                      <div style={{ fontSize: 12, fontWeight: 700, color: '#d97706', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 }}>
                        <i className="feather-shield me-1" style={{ fontSize: 12 }} />
                      ...
                      <div className="mt-3" style={{ background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 10, padding: '12px 14px', fontSize: 12, color: '#991b1b', lineHeight: 1.6 }}>
                        <strong>Khi sân hủy lịch:</strong> Hoàn 100% qua chuyển khoản thủ công.
                      </div>
                    </div>
                  </div>
                </div>
                <div className="modal-footer">
                  <button type="button" className="btn btn-outline-secondary" onClick={() => setPreviewOpen(false)}>
                    Đóng
                  </button>
                </div>
              </div>
